#include <koko_controllers/KokoJointGroupPositionController.h>
...
namespace koko_controllers
{
  ...
  KokoJointGroupPositionController::KokoJointGroupPositionController() {}
  KokoJointGroupPositionController::~KokoJointGroupPositionController() {sub_command_.shutdown();}

  bool KokoJointGroupPositionController::init(hardware_interface::EffortJointInterface* hw, ros::NodeHandle &n)
  {
    ...
    sub_command_ = n.subscribe<std_msgs::Float64MultiArray>("command", 1, &KokoJointGroupPositionController::commandCB, this);
    ROS_ERROR_STREAM("Starting Controller");
    return true;
  }

  void KokoJointGroupPositionController::update(const ros::Time& time, const ros::Duration& period)
  {
  ...
  void KokoJointGroupPositionController::enforceJointLimits(double &command, unsigned int index)
  {
...
PLUGINLIB_EXPORT_CLASS( koko_controllers::KokoJointGroupPositionController, controller_interface::ControllerBase)
