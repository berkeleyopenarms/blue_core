...
class BLDCControllerClient {
  public:
    ...
    void queueSetPosCommand(comm_id_t board_id, float position, float feed_forward);
    ...
    void queueSetPosCommandAndGetState(comm_id_t board_id, float position, float feed_forward);
