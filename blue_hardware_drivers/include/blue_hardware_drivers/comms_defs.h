...
constexpr comm_addr_t COMM_REG_CAL_MOTOR_T = 0x1021; // Torque Constant
...
constexpr uint32_t COMM_BOOTLOADER_OFFSET = 0x08000000;
constexpr uint32_t COMM_NVPARAMS_OFFSET = 0x08004000;
constexpr uint32_t COMM_FIRMWARE_OFFSET = 0x08008000;
constexpr uint32_t COMM_DEFAULT_BAUD_RATE = 1000000;
